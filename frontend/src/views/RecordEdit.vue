<template>
    <div class="pt-4 px-4">
        <h1 class="text-4xl font-bold mb-6">Dispatch ID {{ route.params.id }}</h1>
...
const fireEngines = ref([
    ...
    { id: 3, engine_number: '306', selected: true }
]);

const equipmentList = ref([
    { id: 1, name: 'Hoses', selected: true },
    { id: 2, name: 'Ladders', selected: false },
    { id: 3, name: 'Fire Extinguishers', selected: true }
]);
...
const fireFighters = ref([
    ...
    { id: 5, name: 'Abby Swan', selected: true },
