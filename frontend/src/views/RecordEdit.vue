<template>
    <div class="pt-4 px-4">
        <h1 class="text-4xl font-bold mb-6">Edit Dispatch {{ dispatch.id }}</h1>
...
const fetchdata = async () => {
    ...
    const dispatch_res = await apiClient.get(`/fire-station/dispatch/${route.params.id}/`)
    selectedStation.value = dispatch_res.data.station_detail

    dispatch.value.id = dispatch_res.data.id
    dispatch.value.incident = dispatch_res.data.incident
    dispatch.value.address = dispatch_res.data.address
    dispatch.value.station = dispatch_res.data.station
    dispatch.value.reported_time = dispatch_res.data.reported_time
    dispatch.value.notified_time = dispatch_res.data.notified_time
    dispatch.value.resolved_time = dispatch_res.data.resolved_time
}
